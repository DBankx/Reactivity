...
const ActivityDetailedChat = () => {
    ...
    const {addComment, createHubConnection, stopHubConnection, activity} = rootStore.activityStore;
    
    // create the hub connection and cleanup with the stop hub connection
    useEffect(() => {
